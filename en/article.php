            ...
            <div class="article">
                <div class="header-article">
                    ...
                    <?php
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $result=$cnx->query("SELECT titre FROM article_en WHERE id=$id");
                            if ($result) {
               ...
               <div class="content-article">
                    <?php
                        function articleNotFound() {
                            echo "<h1>Sorry, we couldn't find the article you were looking for.</h1>";
                        }

                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $result = $cnx->query("SELECT contenu FROM article_en WHERE id=$id");
                            if ($result) {
